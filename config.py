...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b> Kᴏɴɴɪᴄʜɪᴡᴀ {first} 👋 </b>\n\nI am pleased to inform you that I can provide you Anime Files with With Special Link Generated By Admins.\n\nTo access these links, please visit our Channel at @jjustanime....")
try:
    ADMINS=[6727550037]
    for x in (os.environ.get("ADMINS", " 7162615398 6727550037").split()):
        ADMINS.append(int(x))
except ValueError:
