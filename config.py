...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7338724714:AAH57fuFOvrzRvOdi4eAAR_Q3lcOMWGN6Tw")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002100237972"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002170138276"))
...
try:
    ADMINS=[6727550037]
    for x in (os.environ.get("ADMINS", "6727550037 7162615398 5355745915 5834350988 5747882115 6911235730").split()):
        ADMINS.append(int(x))
except ValueError:
...
USER_REPLY_TEXT = "❌ Dᴏɴ'ᴛ sᴇɴᴅ ᴍᴇ ᴍᴇssᴀɢᴇs ᴅɪʀᴇᴄᴛʟʏ I ᴏɴʟʏ Wᴏʀᴋ Fᴏʀ @Mikey_anime_team..."
